...
import com.istech.lighthouse.databinding.ActivityDateWiseConsumptionBinding
...
class DateWiseConsumptionActivity : BaseActivity() {
    private lateinit var binding: ActivityDateWiseConsumptionBinding
    var fromDate = "12-12-2021"
    private val TAG = "DateWiseConsumptionActi"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        context = this
        activity = this
        binding = DataBindingUtil.setContentView(this, R.layout.activity_date_wise_consumption)
        handleCLick()
        initView()
    }
    ...
    private fun getRecentData(){
        ...
        disposable.add(
            Global.initRetrofit().getDateWiseData(header,map).subscribeOn(Schedulers.io())
